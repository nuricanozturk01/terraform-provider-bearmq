...
func (d *exchangeDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"durable":     schema.BoolAttribute{Computed: true, MarkdownDescription: "Whether the exchange survives a broker restart."},
			"internal":    schema.BoolAttribute{Computed: true, MarkdownDescription: "Whether the exchange rejects direct publishes."},
